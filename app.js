...
var createNewTaskElement=function(taskString){
    ...
    editButton.className="list-item__button";

    deleteButton.className="list-item__button";
...
var editTask=function(){
    ...
    var editBtn=listItem.querySelector(".list-item__button");
...
//select ListItems children
    ...
    var [editButton, deleteButton] = taskListItem.querySelectorAll('.list-item__button')
